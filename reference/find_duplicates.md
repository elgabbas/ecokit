...
#> 1 …jAgB06/example1         1 <tibble> txt            3            0 d3608428aac…
...
#>   <chr>                                     <fs::path>       <dttm>             
#> 1 /tmp/RtmpjAgB06/example1/file1.txt        file1.txt        2025-12-09 14:51:00
#> 2 /tmp/RtmpjAgB06/example1/file2.txt        file2.txt        2025-12-09 14:51:00
#> 3 /tmp/RtmpjAgB06/example1/subdir/file3.txt subdir/file3.txt 2025-12-09 14:51:00
#> 
...
#> 1 dir_a      /tmp/RtmpjAgB06/example2/dir_a       1          3         1
#> 2 dir_b      /tmp/RtmpjAgB06/example2/dir_b       1          3         1
#> 3 dir_c      /tmp/RtmpjAgB06/example2/dir_c       1          3         1
#> 
#> --------------------------------
#>   >>  Duplicated files
#> --------------------------------
...
#>   path             dup_group files    file_ext n_files file_size_mb content_hash
#>   <fs::path>           <int> <list>   <chr>      <int>        <dbl> <chr>       
#> 1 …jAgB06/example2         1 <tibble> txt            2            0 39a16930dd4…
#> 2 …jAgB06/example2         2 <tibble> txt            2            0 3294155fa14…
...
#>   file_abs                                 file_rel        modified           
#>   <chr>                                    <fs::path>      <dttm>             
#> 1 /tmp/RtmpjAgB06/example2/dir_a/file1.txt dir_a/file1.txt 2025-12-09 14:51:00
#> 2 /tmp/RtmpjAgB06/example2/dir_b/file1.txt dir_b/file1.txt 2025-12-09 14:51:00
#> 
#> [[2]]
#> # A tibble: 2 × 3
#>   file_abs                                 file_rel        modified           
#>   <chr>                                    <fs::path>      <dttm>             
#> 1 /tmp/RtmpjAgB06/example2/dir_a/file2.txt dir_a/file2.txt 2025-12-09 14:51:00
#> 2 /tmp/RtmpjAgB06/example2/dir_b/file2.txt dir_b/file2.txt 2025-12-09 14:51:00
#> 
...
#>   dir        dir_abs                         n_files n_dup_dirs dup_group
#>   <fs::path> <fs::path>                        <int>      <int>     <int>
#> 1 group1     /tmp/RtmpjAgB06/example4/group1       1          5         1
#> 2 group2     /tmp/RtmpjAgB06/example4/group2       1          5         1
#> 3 group3     /tmp/RtmpjAgB06/example4/group3       1          5         1
#> 4 group4     /tmp/RtmpjAgB06/example4/group4       1          5         1
#> 5 group5     /tmp/RtmpjAgB06/example4/group5       1          5         1
#> 
#> --------------------------------
#>   >>  Duplicated files
#> --------------------------------
...
#>   path             dup_group files    file_ext n_files file_size_mb content_hash
#>   <fs::path>           <int> <list>   <chr>      <int>        <dbl> <chr>       
#> 1 …jAgB06/example4         1 <tibble> txt            3            0 289d4cf190e…
#> 2 …jAgB06/example4         2 <tibble> txt            3            0 d5735c1086d…
#> 3 …jAgB06/example4         3 <tibble> txt            3            0 31575137fb5…
#> 4 …jAgB06/example4         4 <tibble> txt            3            0 e4f4464959f…
#> 5 …jAgB06/example4         5 <tibble> txt            3            0 8506efe5d5b…
