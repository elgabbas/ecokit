...
#> File: /tmp/Rtmpyp01Cy/image_test/not_an_image.txt
#> [1] FALSE
...
#> Warning: The file '/tmp/Rtmpyp01Cy/image_test/nonexistent_image.jpg' does not exist.
#> [1] FALSE

check_image(temp_dir)
#> Warning: Input `file` '/tmp/Rtmpyp01Cy/image_test' is a directory.
#> [1] FALSE
