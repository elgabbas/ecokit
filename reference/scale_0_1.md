...
#> sources     : memory  
#>               spat_20c974123dbf_8393_6Uxy02myoMrg5LO.tif  
#> names       :     lyr.1, lyr.1 
#> min values  : -2.309088,     0 
...
#> source      : spat_20c9778c7135_8393_rG2neQku8ByG59H.tif 
#> name        : lyr.1 
#> min value   :     0 
#> max value   :     1 
#> 
...
#> coord. ref. : lon/lat WGS 84 (EPSG:4326) 
#> sources     : raster.tif  
#>               spat_20c9643efbcc_8393_8nr4ZcY08gqXcRL.tif  
#> names       :     lyr.1, lyr.1 
#> min values  : -2.309088,     0 
#> max values  :  3.463461,     1 
