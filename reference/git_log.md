...
git_log(n_commits = 1)
#> * a7e862d - (grafted, HEAD -> main, origin/main) Add step to copy Google verification file in GitHub Pages workflow (3 minutes ago) <Ahmed El-Gabbas>
...
#> [1] 1
head(log_example, 8)
#> [1] "* a7e862d - (grafted, HEAD -> main, origin/main) Add step to copy Google verification file in GitHub Pages workflow (3 minutes ago) <Ahmed El-Gabbas>"
