...
git_log(n_commits = 1)
#> * 0d6c120 - (grafted, HEAD -> main, origin/main) Remove callr dependency from DESCRIPTION and update documentation for data file integrity checks (3 minutes ago) <Ahmed El-Gabbas>
...
#> [1] 1
head(log_example, 8)
#> [1] "* 0d6c120 - (grafted, HEAD -> main, origin/main) Remove callr dependency from DESCRIPTION and update documentation for data file integrity checks (3 minutes ago) <Ahmed El-Gabbas>"
