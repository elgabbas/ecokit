...
git_log(n_commits = 1)
#> * 41f5905 - (grafted, HEAD -> main, origin/main) enhance save_as for SpatRaster support (3 minutes ago) <Ahmed El-Gabbas>
...
#> [1] 1
head(log_example, 8)
#> [1] "* 41f5905 - (grafted, HEAD -> main, origin/main) enhance save_as for SpatRaster support (3 minutes ago) <Ahmed El-Gabbas>"
