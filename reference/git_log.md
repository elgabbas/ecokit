...
git_log(n_commits = 1)
#> * 5398b1c - (grafted, HEAD -> main, origin/main) Update GitHub Actions workflows to use actions/checkout@v5 and enhance documentation for sampling effort functions (10 minutes ago) <Ahmed El-Gabbas>
...
#> [1] 1
head(log_example, 8)
#> [1] "* 5398b1c - (grafted, HEAD -> main, origin/main) Update GitHub Actions workflows to use actions/checkout@v5 and enhance documentation for sampling effort functions (10 minutes ago) <Ahmed El-Gabbas>"
