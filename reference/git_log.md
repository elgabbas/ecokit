...
git_log(n_commits = 1)
#> * 862150d - (grafted, HEAD -> main, origin/main) Add package_installed function and enhance check_pdf documentation (3 minutes ago) <Ahmed El-Gabbas>
...
#> [1] 1
head(log_example, 8)
#> [1] "* 862150d - (grafted, HEAD -> main, origin/main) Add package_installed function and enhance check_pdf documentation (3 minutes ago) <Ahmed El-Gabbas>"
