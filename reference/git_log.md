...
git_log(n_commits = 1)
#> * a186750 - (grafted, HEAD -> main, origin/main) Enhance set_parallel function (3 minutes ago) <Ahmed El-Gabbas>
...
#> [1] 1
head(log_example, 8)
#> [1] "* a186750 - (grafted, HEAD -> main, origin/main) Enhance set_parallel function (3 minutes ago) <Ahmed El-Gabbas>"
