...
git_log(n_commits = 1)
#> * 8ee4760 - (grafted, HEAD -> main, origin/main) modify installation instructions and add logo to documentation (4 minutes ago) <Ahmed El-Gabbas>
...
#> [1] 1
head(log_example, 8)
#> [1] "* 8ee4760 - (grafted, HEAD -> main, origin/main) modify installation instructions and add logo to documentation (4 minutes ago) <Ahmed El-Gabbas>"
