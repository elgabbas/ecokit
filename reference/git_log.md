...
git_log(n_commits = 1)
#> * 682c398 - (grafted, HEAD -> main, origin/main) small fix (3 minutes ago) <Ahmed El-Gabbas>
...
#> [1] 1
head(log_example, 8)
#> [1] "* 682c398 - (grafted, HEAD -> main, origin/main) small fix (3 minutes ago) <Ahmed El-Gabbas>"
