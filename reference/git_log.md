...
git_log(n_commits = 1)
#> * 9a1d9a4 - (grafted, HEAD -> main, origin/main) Add google site verification HTML file (4 minutes ago) <Ahmed El-Gabbas>
...
#> [1] 1
head(log_example, 8)
#> [1] "* 9a1d9a4 - (grafted, HEAD -> main, origin/main) Add google site verification HTML file (4 minutes ago) <Ahmed El-Gabbas>"
