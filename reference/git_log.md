...
git_log(n_commits = 1)
#> * 6cdff9a - (grafted, HEAD -> main, origin/main) Enhance load_packages and reload_package functions for improved performance and error handling; optimize package version retrieval and validation. (3 minutes ago) <Ahmed El-Gabbas>
...
#> [1] 1
head(log_example, 8)
#> [1] "* 6cdff9a - (grafted, HEAD -> main, origin/main) Enhance load_packages and reload_package functions for improved performance and error handling; optimize package version retrieval and validation. (3 minutes ago) <Ahmed El-Gabbas>"
