...
git_log(n_commits = 1)
#> * 0dae5a6 - (grafted, HEAD -> main, origin/main) Refactor get_sampling_effort function to streamline file validation and error handling; update set_raster_varnames to return rast directly. (3 minutes ago) <Ahmed El-Gabbas>
...
#> [1] 1
head(log_example, 8)
#> [1] "* 0dae5a6 - (grafted, HEAD -> main, origin/main) Refactor get_sampling_effort function to streamline file validation and error handling; update set_raster_varnames to return rast directly. (3 minutes ago) <Ahmed El-Gabbas>"
