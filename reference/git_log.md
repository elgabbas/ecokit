...
git_log(n_commits = 1)
#> * 13a5e41 - (grafted, HEAD -> main, origin/main) Add get_inat_obs function (3 minutes ago) <Ahmed El-Gabbas>
...
#> [1] 1
head(log_example, 8)
#> [1] "* 13a5e41 - (grafted, HEAD -> main, origin/main) Add get_inat_obs function (3 minutes ago) <Ahmed El-Gabbas>"
