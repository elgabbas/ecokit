...
git_log(n_commits = 1)
#> * 122204b - (grafted, HEAD -> main, origin/main) Small changes to documentation (3 minutes ago) <Ahmed El-Gabbas>
...
#> [1] 1
head(log_example, 8)
#> [1] "* 122204b - (grafted, HEAD -> main, origin/main) Small changes to documentation (3 minutes ago) <Ahmed El-Gabbas>"
