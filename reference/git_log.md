...
git_log(n_commits = 1)
#> * 680e6f9 - (grafted, HEAD -> main, origin/main) Fix load_tar_file documentation to use base read.csv instead of readr::read_csv (3 minutes ago) <Ahmed El-Gabbas>
...
#> [1] 1
head(log_example, 8)
#> [1] "* 680e6f9 - (grafted, HEAD -> main, origin/main) Fix load_tar_file documentation to use base read.csv instead of readr::read_csv (3 minutes ago) <Ahmed El-Gabbas>"
