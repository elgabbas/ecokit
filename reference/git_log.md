...
git_log(n_commits = 1)
#> * a62fd25 - (grafted, HEAD -> main, origin/main) Refactor CI workflows and update documentation for CHELSA data functions (13 minutes ago) <Ahmed El-Gabbas>
...
#> [1] 1
head(log_example, 8)
#> [1] "* a62fd25 - (grafted, HEAD -> main, origin/main) Refactor CI workflows and update documentation for CHELSA data functions (13 minutes ago) <Ahmed El-Gabbas>"
