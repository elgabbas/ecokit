...
git_log(n_commits = 1)
#> * a6d0fa2 - (grafted, HEAD -> main, origin/main) Update documentation and add new functions: `get_sampling_effort` and `mask_cumulative_pct` with corresponding documentation (5 minutes ago) <Ahmed El-Gabbas>
...
#> [1] 1
head(log_example, 8)
#> [1] "* a6d0fa2 - (grafted, HEAD -> main, origin/main) Update documentation and add new functions: `get_sampling_effort` and `mask_cumulative_pct` with corresponding documentation (5 minutes ago) <Ahmed El-Gabbas>"
