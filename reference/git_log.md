...
git_log(n_commits = 1)
#> * 1dd1e8a - (grafted, HEAD -> main, origin/main) Update package metadata and add PDF integrity check function (3 minutes ago) <Ahmed El-Gabbas>
...
#> [1] 1
head(log_example, 8)
#> [1] "* 1dd1e8a - (grafted, HEAD -> main, origin/main) Update package metadata and add PDF integrity check function (3 minutes ago) <Ahmed El-Gabbas>"
