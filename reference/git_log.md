...
git_log(n_commits = 1)
#> * 2deac39 - (grafted, HEAD -> main, origin/main) Fix binned_heatmap for faster rasterization (4 minutes ago) <Ahmed El-Gabbas>
...
#> [1] 1
head(log_example, 8)
#> [1] "* 2deac39 - (grafted, HEAD -> main, origin/main) Fix binned_heatmap for faster rasterization (4 minutes ago) <Ahmed El-Gabbas>"
