...
git_log(n_commits = 1)
#> * 9c74b7d - (grafted, HEAD -> main, origin/main) Update pkgdown build command and enhance README documentation (4 minutes ago) <Ahmed El-Gabbas>
...
#> [1] 1
head(log_example, 8)
#> [1] "* 9c74b7d - (grafted, HEAD -> main, origin/main) Update pkgdown build command and enhance README documentation (4 minutes ago) <Ahmed El-Gabbas>"
