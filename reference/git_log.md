...
git_log(n_commits = 1)
#> * e63ad88 - (grafted, HEAD -> main, origin/main) Add raster_dims_km function to the pkgdown configuration (4 minutes ago) <Ahmed El-Gabbas>
...
#> [1] 1
head(log_example, 8)
#> [1] "* e63ad88 - (grafted, HEAD -> main, origin/main) Add raster_dims_km function to the pkgdown configuration (4 minutes ago) <Ahmed El-Gabbas>"
