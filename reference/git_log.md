...
git_log(n_commits = 1)
#> * 6711e0d - (grafted, HEAD -> main, origin/main) Fix linting (3 minutes ago) <Ahmed El-Gabbas>
...
#> [1] 1
head(log_example, 8)
#> [1] "* 6711e0d - (grafted, HEAD -> main, origin/main) Fix linting (3 minutes ago) <Ahmed El-Gabbas>"
