...
#>  [79] "package_functions"          "package_remote_sha"        
#>  [81] "pak_from_renv"              "parent_dir"                
#>  [83] "polygon_centroid"           "quiet_device"              
#>  [85] "quietly"                    "range_to_new_value"        
#>  [87] "raster_dims_km"             "raster_to_pres_abs"        
#>  [89] "record_arguments"           "reload_package"            
#>  [91] "remove_options"             "rename_geometry"           
#>  [93] "replace_space"              "sapply_"                   
#>  [95] "save_as"                    "save_multiple"             
#>  [97] "save_session"               "save_session_info"         
#>  [99] "scale_0_1"                  "scrape_link"               
#> [101] "script_location"            "set_geometry"              
#> [103] "set_parallel"               "set_raster_crs"            
#> [105] "set_raster_varnames"        "sf_add_coords"             
#> [107] "sort_raster_layers"         "source_silent"             
#> [109] "split_df_to_chunks"         "split_raster"              
#> [111] "split_vector"               "stop_ctx"                  
#> [113] "system_command"             "text_to_coordinates"       
#> [115] "tibble_column_size"         "used_packages"             
#> [117] "write_nc"                   "zenodo_download_file"      
#> [119] "zenodo_file_list"          
