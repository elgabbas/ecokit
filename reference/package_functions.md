...
#>  chr [1:155] "%>%" "FULL_bbox_" "NA_agr_" "NA_bbox_" "NA_crs_" ...
...
#>  [51] "get_option_with_default"    "get_sampling_effort"       
#>  [53] "git_log"                    "ht"                        
#>  [55] "info_chunk"                 "integer_breaks"            
#>  [57] "keep_only"                  "lapply_"                   
#>  [59] "list_to_rdata"              "load_as"                   
#>  [61] "load_multiple"              "load_packages"             
#>  [63] "load_packages_future"       "load_tar_file"             
#>  [65] "loaded_packages"            "mask_cumulative_pct"       
#>  [67] "maxent_open"                "maxent_variable_importance"
#>  [69] "n_decimals"                 "n_unique"                  
#>  [71] "nc_global_attributes"       "nearest_dist_sf"           
#>  [73] "normalize_path"             "os"                        
#>  [75] "package_functions"          "package_remote_sha"        
#>  [77] "pak_from_renv"              "parent_dir"                
#>  [79] "polygon_centroid"           "quiet_device"              
#>  [81] "quietly"                    "range_to_new_value"        
#>  [83] "raster_dims_km"             "raster_to_pres_abs"        
#>  [85] "record_arguments"           "reload_package"            
#>  [87] "remove_options"             "rename_geometry"           
#>  [89] "replace_space"              "sapply_"                   
#>  [91] "save_as"                    "save_multiple"             
#>  [93] "save_session"               "save_session_info"         
#>  [95] "scale_0_1"                  "scrape_link"               
#>  [97] "script_location"            "set_geometry"              
#>  [99] "set_parallel"               "set_raster_crs"            
#> [101] "sf_add_coords"              "source_silent"             
#> [103] "split_df_to_chunks"         "split_raster"              
#> [105] "split_vector"               "stop_ctx"                  
#> [107] "system_command"             "text_to_coordinates"       
#> [109] "tibble_column_size"         "used_packages"             
#> [111] "write_nc"                   "zenodo_download_file"      
#> [113] "zenodo_file_list"          
