...
#> Warning: Failed to load RData file: /tmp/RtmparB8sB/load_multiple/invalid.Rdata
#> [1] FALSE
...
#> Warning: Failed to load qs2 file: /tmp/RtmparB8sB/load_multiple/invalid.qs2
#> [1] FALSE
...
check_rds(bad_rds)
#> Warning: Failed to load rds file: /tmp/RtmparB8sB/load_multiple/invalid.rds
#> [1] FALSE
...
#> Warning: Failed to load feather file: /tmp/RtmparB8sB/load_multiple/invalid.feather
#> [1] FALSE
