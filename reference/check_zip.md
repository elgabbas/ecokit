...
check_zip(bad_zip)
#> Warning: Warning during file validation: running command 'unzip -t '/tmp/RtmpCgFISY/check_zip/invalid.zip'' had status 9
#> [1] FALSE
...
check_zip(empty_zip)
#> Warning: File is empty: /tmp/RtmpCgFISY/check_zip/empty.zip
#> [1] FALSE
...
#> Warning: Warning during file validation: running command 'unzip -t '/tmp/RtmpCgFISY/check_zip/test.txt'' had status 9
#> [1] FALSE
