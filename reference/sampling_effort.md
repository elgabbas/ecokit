...
#> Request failed (Status code: 502). Retrying in 7s...
...
#> /tmp/Rtmp4rODlN/sampling_efforts/n_obs_Aves_res_20.tif
#> 
...
#> 
#> file_tiff [file_tiff]: <fs_path + character>
#> /tmp/Rtmp4rODlN/sampling_efforts/n_obs_Lepidoptera_total_res_10.tif
#> 
#> down_url [down_url]: <character>
#> https://osf.io/download/69162b43bdc702dce1e2fd62/
#> 
#> group [group]: <character>
#> insecta
#> 
